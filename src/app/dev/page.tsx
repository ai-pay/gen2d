...
export default async function Home() {
  return <>
    <MainHeader />
    <main
      className="flex min-h-screen flex-col items-center justify-start w-[90vw] sm:w-[512px] mx-auto gap-3 text-center">
      ...
      <Image
        ...
        width={1024}
        height={1024}
        src="https://img.gen2d.dev/fb3fc15a-de64-4f05-913f-0449412d41c0-1024.jpg"
        alt={"Profile image"} />
    </main>
  </>;
}
